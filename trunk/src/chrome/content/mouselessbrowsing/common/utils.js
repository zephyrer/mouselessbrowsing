var MLB_Utils = {
    ...
    getCharPref: function(key){
        return MLB_Utils.prefs.prefHasUserValue(key)?MLB_Utils.prefs.getCharPref(key):null;
    },
    
    getBoolPref: function(key){
        return MLB_Utils.prefs.prefHasUserValue(key)?MLB_Utils.prefs.getBoolPref(key):false;
    },

    hasUserPref: function(key){
    	return MLB_Utils.prefs.prefHasUserValue(key);
   	},
   	setCharPref: function(key, value){
   		MLB_Utils.prefs.setCharPref(key, value);
   	},
    /*
    ...
    logError: function(error){
        ...
        MLB_Utils.logMessage(errorMessage);
    }
}